...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  return [
    ...
    { url: `${base}/migrate-from/spreadsheets`, lastModified: now, changeFrequency: "monthly", priority: 0.8 },
    { url: `${base}/migrate-from/weldtrace`, lastModified: now, changeFrequency: "monthly", priority: 0.8 },
    { url: `${base}/migrate-from/weldeye`, lastModified: now, changeFrequency: "monthly", priority: 0.8 },
